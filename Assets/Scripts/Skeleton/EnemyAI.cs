...
public class EnemyAI : MonoBehaviour
{
    ...
    public bool IsDead => _currentState == State.Death;
    ...
    private void AttackingTarget()
    {
        if (Time.time > _nextAttackTime)
        {
            ...
            if (AudioManagerSample.Instance != null)
                AudioManagerSample.Instance.PlaySFX(AudioManagerSample.Instance.enemyAttackClip);
